...
const AdminLeftBar = () => {
  ...
  return (
    <><div className='w-full h-full bg-green-500/20 flex justify-center items-center'>AdminLeftBar</div><div className='w-full h-screen shadow-purple-400 shadow-md flex justify-center items-center'>
